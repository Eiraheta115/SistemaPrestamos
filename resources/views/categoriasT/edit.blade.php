...
<div class="card">
        ...
        <div class="card-body">
                <form action="{{route('updateT', $categoria->id)}}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="input-group mb-3">
                                ...
                                <input type="number" step="1" min="1" name="rangoInicial" id="rangoInicial" class="form-control" value="{{$categoria->rangoInicial}}">
                        </div>
                        ...
                        <div class="input-group mb-3">
                                ...
                                <input type="number" step="1" min="1" name="rangoFinal" id="rangoFinal" class="form-control" value="{{$categoria->rangoFinal}}">
                        </div>
